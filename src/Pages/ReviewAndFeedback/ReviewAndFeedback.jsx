...
<section className="text-gray-600 body-font">
  <div className="container px-5 py-24 mx-auto">
    <h1 className="text-3xl font-medium title-font text-gray-900 mb-12 text-center">Review and Feedbacks</h1>
    <div className="flex flex-wrap -m-4">
      {
reviews?.map(review => <div key={review._id} className="p-4 md:w-1/2 w-full">
        <div className="h-full bg-gray-100 p-8 rounded">
          ...
          <a className="inline-flex items-center">
            ...
            <span className="flex-grow flex flex-col pl-4">
              ...
              <span className="text-gray-500 text-sm uppercase">{review.job}</span>
            </span>
          </a>
        </div>
